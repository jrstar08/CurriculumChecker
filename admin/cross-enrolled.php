        ...
        <div class="container-fluid mt-4">
            <!-- START -->
                <div class="ui container">
                    <h3 style="text-align: center;">Cross-Enrolled</h3>
                        ...
                        <table class="ui striped table" id="school_table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Cross-Enrolled Subject Code</th>
                                    <th>AYSEM</th>
                                    <th>School</th>
                                    <th>Action</th>
                                </tr>
                                ...
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result))
                                    {
                                        ...
                                        echo '<tr>';
                                            ...
                                            echo '<td>'.$school.'</td>';
                                            echo '<td>';
                                                echo '<button class="ui red button delete" id="delete_'.$row["id"].'"><img src="lib/delete.png" style="width: 15px;"></button>';
                                            echo '</td>';
                                    }
                                ?>
                            </tbody>
...
<script>
    function delete_buttonn(idd){
        $.ajax({
            url:"cross-enrolled_delete.php",
            method:"POST",
            data:{
                type:"DELETE_DATAS",
                id:idd
...
<script>
    $('#add_button').click(function(){
        location = 'cross-enrolled_add.php';
    });
    $('.edit').click(function(){
        var output = '';
    ...
    $('.delete').click(function(){
        ...
        id = id[1];
        // Breadcrumbs
        output += '<nav aria-label="breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="cross-enrolled.php">Home</a></li><li class="breadcrumb-item active" aria-current="page">Delete School</li></ol></nav>';
        // AJAX FOR REQUESTING THE EDIT DATAS
        $.ajax({
            url:"cross-enrolled_delete.php",
            method:"POST",
            ...
            success:function(data){
                ...
                // CARD
                output += '<div class="ui cards centered"><div class="card"><div class="content"><div class="right floated mini ui image" style="font-size: 110%;">#' + id + '</div><div class="header">' + school[0] + '</div><div class="meta">' + school[1] + '</div><div class="description" style="margin-bottom: 0;">' + school[2] + '</div></div><div class="extra content"><div class="ui two buttons"><button class="ui red button" onclick="delete_buttonn('+id+')">Delete</button></div></div></div></div>';
                $('#output').html(output);
            }
        });
    });
