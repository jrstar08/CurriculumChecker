                ...
                <div class="ui container">
                    ...
                    <div id="output" style="margin: 15px;">
                        <table class="ui striped table" id="school_table">
                            ...
                            <tbody>
                                <?php
                                    $query = "select * from cross_enrolled_subjects join students on students.studentid = cross_enrolled_subjects.studentid join schools on schools.school_id = cross_enrolled_subjects.schoolid";
