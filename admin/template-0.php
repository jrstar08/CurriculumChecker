...
<body class="fixed-sn light-blue-skin">
        ...
        <div class="container-fluid mt-5" style="margin-top: 0; padding-top: 0; top: 0; width: 100%; margin-left: 0;">
            <!-- START -->
                <div class="ui container" style="margin-top: 0; width: 100%;">
                    <h2 style="text-align: center">FILTER</h2><br>
                    <!-- FIRST FILTER -->
                    ...
                    <div id="filter4">
                        <!--Blue select-->
                        <select class="mdb-select colorful-select dropdown-primary" id="all_course">
                            <option value="CET">CET</option>
                            <option value="CS">CS</option>
                            <option value="CN">CN</option>
                            <option value="CBGM">CBGM</option>
    ...
    <script>
        ...
        $('input[type=radio][name=filter1]').change(function(){
            ...
            $('#output').html(query + college + course);
        });
        ...
        $('#per_college').change(function(){
            ...
            $('#filter3').show();
            $('#filter4').hide();
            college = " WHERE COLLEGE = " + this.value;
            course = "";
