<?php 
    include('connect.php'); 
    include('curriculum_filtering_subjects.php');    
...
<body style="margin: 0; padding: 0;">
    ...
    <div style="background-color: #B71C1C; height: 60px; box-shadow: 0px 0px 1px #000; padding: 20px; margin-bottom: 20px;">
        ...
        <div style="color: white; text-align: right; margin-top: 3px; font-weight: bold; font-size: 105%;">CUSTOM STUDY PLAN</div>
    </div>
