...
<?php 
  ...
  while($row = mysqli_fetch_row($result))
  {
    ...
    $query1 = "select clusterid1 from curricula1 where subjectid = '$row[4]'";
    ...
    {
      $query1 = "select finalgrade from grades where subjectid = '$clusterid_subject[$i]' and studentid = '$studentid' order by classid desc";
      $result1 = mysqli_query($conn, $query1);

      if(mysqli_num_rows($result1))
      {
        $row1 = mysqli_fetch_row($result1);
        echo '<td class="cent" colspan="2">'.$row1[0].'</td>';
...
<tr><td colspan="3">PED 11</td><td colspan="8">Foundation of Physical Activities</td><td class="cent">(2)</td><td colspan="4"></td>
<?php
...
<tr><td colspan="3">NSTP 11</td><td colspan="8">ROTC/CWTS</td><td class="cent">(3)</td><td colspan="4"></td>
<?php
...
<tr>
  ...
  <td colspan="4"></td>
  <td class="cent" colspan="2" style="color: red; text-align: center;"><?php if($with_grades == true) echo round($totalgrades/$totalunits_active, 4); ?></td>
</tr>
</table>
