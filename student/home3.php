...
<body class="fixed-sn light-blue-skin" onload="hello();">
            ...
            <ul class="custom-scrollbar list-unstyled" style="max-height:100vh;">
                ...
                <li>
                    <ul class="collapsible collapsible-accordion">
                        <li><a href="home1.php" class="collapsible-header waves-effect arrow-r" style="font-size: 102%"><b>Home</b></a></li>
                        <li><a href="logout.php" class="collapsible-header waves-effect arrow-r" style="font-size: 102%"><b><?php echo 'Logout'; ?></b></a></li>
                    </ul>
                </li>
                <!--/. Side navigation links -->
            </ul>
    ...
    <script>
        function hello(){
            $.bootstrapGrowl("HI <?php echo $firstname; ?>!", {
